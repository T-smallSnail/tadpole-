 ...
 * @version 2017-11-28
 */
public class LmtBudgetControlStrategy extends DataEntity<LmtBudgetControlStrategy> {
	...
	public LmtBudgetControlStrategy() {
		super();
	}

	public LmtBudgetControlStrategy(String id){
		super(id);
	}
