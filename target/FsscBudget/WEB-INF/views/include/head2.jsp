...
<script defer="defer" src="${ctxStatic}/jquery-select2/3.4/select2.min.js" type="text/javascript"></script>
<%-- <script defer="defer" src="${ctxStatic}/styleInteractionJs/styleInteraction.js?version=${fsscVersion}" type="text/javascript"></script> --%><!-- 合并到jeesite.js文件中 -->
<link href="${ctxStatic}/jquery-validation/1.11.0/jquery.validate.css" type="text/css" rel="stylesheet" />
<script defer="defer" src="${ctxStatic}/jquery-validation/1.11.0/jquery.validate.js?version=${fsscVersion}" type="text/javascript"></script>
...
<%-- <script defer src="${ctxStatic}/My97DatePicker/WdatePicker.js" type="text/javascript"></script> --%>
