...
<head>
	...
	<script type="text/javascript">
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:"${checked}",nocheckInherit:true},
				async:{enable:true, url:"${ctx}${url}?sceneId=ASYNDEPART01",autoParam:["id", "name=n", "level=lv"]},
		...
		$(document).ready(function(){
			/* $.get("${ctx}${url}${fn:indexOf(url,'?')==-1?'?':'&'}&sceneId=${sceneId}&extId=${extId}&isAll=${isAll}&module=${module}&t="
...
<body>
	...
	<input type="text" id="parmsId" name="parmsId" value="${parms}" />
</body>