...
<!-- begin -->
<script src="${ctxStatic}/print/js/LodopFuncs.js" type="text/javascript"></script>
<script src="${ctxStatic}/print/js/print.js" type="text/javascript"></script>
<object id="LODOP_OB"
	classid="clsid:2105C259-1E0C-4534-8141-A753534CB4CA" width=0 height=0>
	<embed id="LODOP_EM" type="application/x-print-lodop" width=0 height=0
		pluginspage="${ctxStatic}/print/install_lodop32.exe"></embed>
</object>
<!-- end -->
</head>
<body>
