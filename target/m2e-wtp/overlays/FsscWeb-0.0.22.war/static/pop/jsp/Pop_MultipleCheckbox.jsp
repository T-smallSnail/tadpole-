...
<link rel="stylesheet" href="${ctxStatic}/pop/bootstrap/css/bootstrapCopy.css" />
...
<%
	...
	%>
<body class="body_bg" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-922" data-genuitec-path="/FsscWeb/src/main/webapp/static/pop/jsp/Pop_MultipleCheckbox.jsp">
	<style data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-922" data-genuitec-path="/FsscWeb/src/main/webapp/static/pop/jsp/Pop_MultipleCheckbox.jsp">
#tablist {
	width: 98%;
	margin: 0 auto 15px;
}
	...
	<div class="overall-layoutSEO">
		...
		<s:form method="post" theme="simple" name="cms_form"
			...
			<div class="pop-mucheckbox-bottom" class='pr'>
				...
				<div>
					<table id="tablist" width="100%" border="0" align="center" cellspacing="1" class="table table-bordered table-striped table-hover" style="background:#fff;">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		colval = colvals.split("-");
		parentval = window.parent.document.getElementsByName(colval[1]);
		var parentvalue = parentval[0].value;
		var parentvals = parentvalue.split("@");
		var pararrs = "";
		var parvalues = "";
		$("input[name='pop_box']").each(function() {
			pararrs = $(this).val().split("#");
			parvalues = pararrs[0].split("-");
			for (var k = 0; k < parentvals.length; k++) {
				if (parentvals[k] == parvalues[1]) {
					...
					if (parObj != null && typeof (parObj) != "undefined" && parObj.length > 0) {
						...
						if (typeof (parObj[0]) != "undefined")
							...
							if (parObj[0].value != null && parObj[0].value != "")
								...
								parObj[0].value = arr_split[1];else {
