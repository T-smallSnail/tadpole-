...
<%@ attribute name="pId" type="java.lang.String" required="false" description="父编号"%>
...
<div class="input-append ">
	...
	<input id="${id}pId" name="${name}" class="${cssClass}" type="hidden" value="${value}"/>
...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		console.log("====");
		// 正常打开
		top.$.jBox.open("iframe:${ctx}/tag/asyncrlzytreeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&queryParms="+parms, "选择${title}", 400, 560, {opacity: 0.5,
