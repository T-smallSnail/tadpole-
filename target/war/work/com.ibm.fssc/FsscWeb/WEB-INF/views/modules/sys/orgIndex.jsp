	...
	<div id="content" class="row-fluid">
		<div id="left" class="accordion-group">
			<div class="accordion-heading">
		    	<a class="accordion-toggle">组织机构<i class="icon-refresh pull-right" onclick=""></i></a>
		    </div>
			<div id="ztree" class="ztree"></div>
		</div>
		<div id="openClose" class="close">&nbsp;</div>
		<div id="right">
			<iframe id="orgContent" src="${ctx}/sys/org/listDown?id=&parentIds=" width="100%" height="91%" frameborder="0"  ></iframe>
		</div>
	</div>
		...
		var tree, setting = {view:{selectedMulti:false,dblClickExpand:false},check:{enable:false,nocheckInherit:true},
				...
				data:{simpleData:{enable:true}},callback:{
					onClick:function(event, treeId, treeNode){
						...
						$('#orgContent').attr("src","${ctx}/sys/org/listDown?parentNo="+id);
					},
