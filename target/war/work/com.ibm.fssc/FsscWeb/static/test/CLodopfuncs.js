(function (win) {
        var CLODOP = {
        strWebPageID:"ACFmm95",strTaskID:"",strHostURI:"http://10.121.54.87:8000",
                ...
                function() {
                        ...
                        try {
                                if (!this.webskt || this.webskt.readyState==3) {
                                        ...
                                        this.webskt=new WebSocket('ws://10.121.54.87:8000/c_webskt/');
